...
<h3>Doctor Login Form</h3>
  <form action="d_login_res.php" method="POST">
  <table><tr><td>
    <label for="fname">UserNAME</label></td>
    <td><input type="text" id="" name="dml" placeholder="Your use name..">
	</td></tr>
	<tr><td>
    <label for="lname">PassWORD</label></td><td>
    <input type="text" id="" name="dpass" placeholder="Your password..">
	</td></tr>
