...
<form action ="d_reg_data.php" method="POST">
...
<tr>
<td>Date Of Birth <br>(DD-MM-YY) : </td> <td><input type="Date" name="dob"></td></tr>
<tr>
<td>State Name : </td> <td><input type="text" name="st" ></td></tr>
<tr><td>City : </td> <td><input type="text"name="ct"></td></tr>
<tr><td>Addres: : </td> <td><input type="text " name="add"></td></tr>
<tr><td>PhoneNo : </td> <td><input type="number" name="pno" ></td></tr>
