...
<table >
  <tr>
		  <td><h>Disease/Suffering:</h></td><td> <input type="txt"></td></tr>
  <tr>
		  <td><h>Location</h></td><td><input type="txt"></td></tr>
  <tr>
		  <td><h>Doctor name</h></td><td> <input type="txt"></td></tr>
  <tr>
		  <td><h>Old prescriptions</h></td><td> <input type="txt"></td></tr>
  <tr>
		  <td><h>Symptoms</h></td><td> <input type="txt"></td></tr>
 ...
 <tr>
	   ...
	   <div id="d52">
		  <a href="p_history.html">Patient History</a>
	   </div></div>
	   <div id="d4">
		   <div id="d6">
